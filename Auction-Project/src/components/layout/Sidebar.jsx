  ...
  return (
    <aside style={{
      ...
      <div style={{
        ...
        <div style={{ color: '#6b7db3', fontSize: '10px', letterSpacing: '1.5px', fontWeight: 600, paddingLeft: '46px' }}>
          CRICKET LEAGUE AUCTION<br />MANAGEMENT
        </div>
      </div>
      ...
      <div style={{
        padding: '0 0 0',
        background: 'linear-gradient(to top, rgba(15,21,53,0) 0%, rgba(15,21,53,1) 60%)',
        position: 'relative',
        height: '160px',
        overflow: 'hidden',
      }}>
        ...
        <div style={{
          ...
          fontSize: '48px', paddingBottom: '8px', zIndex: 1,
        }}>🏟️</div>
      </div>
    </aside>
  );
