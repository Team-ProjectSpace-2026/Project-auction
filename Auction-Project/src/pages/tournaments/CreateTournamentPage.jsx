...
const CreateTournamentPage = () => {
  ...
  const executeTournamentCreation = async () => {
    ...
    try {
      ...
      payload.append("minSquadSize", Number(formData.maxPlayersPerTeam) || 15);
      payload.append("minReservePerSlot", Number(formData.playerBasePrice) || 100);
      payload.append("maxOverseas", 8);
